...
#define ID_SPRITE_SUNAMI_WALKING_UP (ID_SPRITE_BLACKFOOT+3000)
#define ID_SPRITE_SUNAMI_WALKING_DOWN (ID_SPRITE_BLACKFOOT+4000)
#define ID_SPRITE_SUNAMI_DIE (ID_SPRITE_BLACKFOOT+5000)

#define ID_SPRITE_EYELET 40000
#define ID_SPRITE_EYELET_WALKING_LEFT (ID_SPRITE_BLACKFOOT+1000)
#define ID_SPRITE_EYELET_WALKING_RIGHT (ID_SPRITE_BLACKFOOT+2000)
#define ID_SPRITE_EYELET_WALKING_UP (ID_SPRITE_BLACKFOOT+3000)
#define ID_SPRITE_EYELET_WALKING_DOWN (ID_SPRITE_BLACKFOOT+4000)
#define ID_SPRITE_EYELET_DIE (ID_SPRITE_BLACKFOOT+5000)

#define ID_SPRITE_BELLBOMBER 50000
#define ID_SPRITE_BELLBOMBER_WALKING_LEFT (ID_SPRITE_BLACKFOOT+1000)
#define ID_SPRITE_BELLBOMBER_WALKING_RIGHT (ID_SPRITE_BLACKFOOT+2000)
#define ID_SPRITE_BELLBOMBER_WALKING_UP (ID_SPRITE_BLACKFOOT+3000)
#define ID_SPRITE_BELLBOMBER_WALKING_DOWN (ID_SPRITE_BLACKFOOT+4000)
#define ID_SPRITE_BELLBOMBER_DIE (ID_SPRITE_BLACKFOOT+5000)